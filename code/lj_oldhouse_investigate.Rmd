...
# detail documents and code programing

### code:For more details on using data analysis see <https://github.com/tigerwangcqupt/r_projects-static_project_lj.git>.
...
library(conflicted)
conflict_prefer("filter", "dplyr")  # 明确指定优先使用dplyr版本
conflict_prefer("lag", "dplyr")     # 或根据需求选择stats版本
...
```{r data plot, echo=FALSE,fig.pos='H'}
